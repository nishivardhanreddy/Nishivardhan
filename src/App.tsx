...
const projects: Project[] = [
  ...
  image: "Playerperformance.png", // Replace with your actual project screenshot if available
...
},
{
  ...
  image: "Emotive.png", // Replace with your actual project screenshot if available
  technologies: [
    "Python",
    "Whisper",
    "Groq API (LLaMA 3)",
